...
var MapleMapObjectType = Java.type("guida.server.maps.MapleMapObjectType");
...
function getGroundItems() {
    var items = cm.getPlayer().getMap().getMapObjectsInRange(cm.getPlayer().getPosition(), Packages.java.lang.Double.POSITIVE_INFINITY, Packages.java.util.Arrays.asList([MapleMapObjectType.ITEM]));
