...
package guida.tools.data.input;
...
public final class ByteArrayByteStream implements SeekableInputStreamBytestream {
     ...
     * @see guida.tools.data.input.SeekableInputStreamBytestream#getPosition()
     */
    @Override
     ...
     * @see guida.tools.data.input.SeekableInputStreamBytestream#seek(long)
     */
    @Override
     ...
     * @see guida.tools.data.input.ByteInputStream#getBytesRead()
     */
    @Override
     ...
     * @see guida.tools.data.input.ByteInputStream#readByte()
     */
    @Override
    public int readByte() {
        bytesRead++;
     ...
     * @see guida.tools.data.input.ByteInputStream#available()
     */
    @Override
