...
package guida.tools.performance;
...
public class CPUSampler {
    ...
    private int findRelevantElement(StackTraceElement[] trace) {
        ...
        if (firstIncluded >= 0 && trace[firstIncluded].getClassName().equals("guida.tools.performance.CPUSampler$SamplerThread")) { // don't sample us
            return -1;
        }
